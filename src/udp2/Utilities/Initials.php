...
namespace udp2\Utilities;
    ...
    class Initials
    {
         ...
         */
        public function name(string $nameOrInitials): Initials
        {
        ...
        /**
         * Set if you should keep lettercase on name.
         ...
         * @noinspection PhpUnused
         */
        public function keepCase(bool $keepCase = true): Initials
        {
         ...
         * @noinspection PhpUnused
         */
        public function allowSpecialCharacters(bool $allowSpecialCharacters = true): Initials
        {
         ...
         * @noinspection PhpUnused
         */
        public function length(int $length = 2): Initials
        {
            $this->length = $length;
        ...
        public function getUrlfriendlyInitials(): string
        {
            ...
            return mb_substr($urlFriendlyInitials, 0, $this->length);
        }
         ...
         * and if no name, assume it's already initials.
         * For safety, we limit it to two characters,
         * in case it's a single, but long, name.
         *
         * @return string
         */
        protected function generateInitials(): string
        {
            ...
            return mb_substr($initials, 0, $this->length);
        }
         ...
         * @return string
         */
        protected function convertToUrlFriendlyString($string): string
        {
